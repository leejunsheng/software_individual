...
<div class="w3-card-2 w3-round">
  <div class="w3-white">
    <button onclick="myFunction('Demo1')" class="w3-btn-block bg-primary w3-left-align"><i class="fa fa-file fa-fw w3-margin-right"></i>Concept Note</button>
    <div id="Demo1" class="w3-hide w3-container">
      <p>

        <?php
        #$conceptsql = "SELECT * FROM conceptnote WHERE student = '$regNo'";
        $studentconcept = mysqli_query($dbcon, "SELECT * FROM conceptnote WHERE studentid = '$regNo'") or die(mysqli_error($dbcon));
...
<div class="w3-card-2 w3-round">
  <div class="w3-white">
    <button onclick="myFunction('Demo2')" class="w3-btn-block bg-primary w3-left-align"><i class="fa fa-users fa-fw w3-margin-right"></i> Group </button>
    <div id="Demo2" class="w3-hide w3-container">
      <?php
      #$sqlgroup = "SELECT grpNo FROM members WHERE regNo='$get_user'";
      $sqlgrp = mysqli_query($dbcon, "SELECT grpNo FROM members WHERE regNo='$get_user'") or die(mysqli_error($dbcon));
      ...
      if ($num_row > 0) {
        ...
        <br />
        <p>Your don't have any group yet.<br>Please suggest your group to your supervisor.</p>
...
<div class="w3-card-2 w3-round">
  <div class="w3-white">
    <button onclick="myFunction('Demo3')" class="w3-btn-block bg-primary w3-left-align"><i class="fa fa-file-text fa-fw w3-margin-right"></i> Reports</button>
    <div id="Demo3" class="w3-hide w3-container">

      <p>
        <button class="w3-btn-block w3-grey w3-left-align" onclick="studentReports()"><i class="fa fa-save fa-fw w3-margin-right"></i> View Submitted Report </button>
      </p>
...
<div class="w3-card-2 w3-round w3-white w3-center">
  <button class="w3-btn-block bg-primary w3-left-align" onclick="loadSupervisors()"><i class="fa fa-users fa-fw w3-margin-right"></i> Supervisors </button>
</div>
<br />

<div class="w3-card-2 w3-round w3-white w3-center">
  <button class="w3-btn-block bg-primary w3-left-align" onclick="astorojects()"><i class="fa fa-file-text fa-fw w3-margin-right"></i>Past projects </button>
</div>
<br />
