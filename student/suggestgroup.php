            ...
            <div class="w3-col m12">
              <div class="w3-card-2 w3-white">
                <div class="w3-container w3-padding">
                  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="">
                    ...
                    <div class="w3-row">
                      <div class="w3-col m6"><input type="text" name="fMember" class="w3-input" placeholder="First Member" oninput="showMember(this.value)" required></div>
                      <div class="w3-col m6"><span id="member1"></span></div>
                    </div>
                    <br />
                    <div class="w3-row">
                      <div class="w3-col m6"><input type="text" name="sMember" class="w3-input" placeholder="Second Member" oninput="showMember2(this.value)" required="true"></div>
              ...
              <div class="w3-col m6"><span id="member3"></span></div>
               ...
               <br /-->
                    ...
                    <br />
                    <button type="submit" name="submit" class="w3-padding w3-btn bg-primary">Submit Suggestion</button>
                  </form>
                  <br />
                  <?php
                  ...
                  ?>
                      <script>
                        alert("Your grou suggestion has been recorded");
                      </script>
                    <?php  } else { ?>
                      <script>
                        alert("Sorry, your suggestion failed");
                      </script>
                  <?php
                    }
                  }
