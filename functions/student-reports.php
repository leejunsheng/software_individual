	...
	<div class='w3-row-padding w3-container'>
		<div class='w3-card-2'>
			<table class='w3-table w3-hoverable w3-responsive w3-bordered'>
				...
				<tr>
					<th>Review Report </th>
					<td><a href='' . $reviewfile . '''; > View Report </a></td>
				</tr>
				<tr>
					<th>Semester1 Progress</th>
					<td><a href='' . $sem1_progress . '''; > View Report </a></td>
				</tr>
				<tr>
					<th>Semester1 Final Report</th>
					<td><a href='' . $sem1_final . '''; > View Report </a></td>
				</tr>
				<tr>
					<th>Semester2 Progress</th>
					<td><a href='' . $sem2_progress . '''; > View Report </a></td>
				</tr>
				<tr>
					<th>Final Report</th>
					<td><a href='' . $sem2_final . '''; > View Report </a></td>
				</tr>
