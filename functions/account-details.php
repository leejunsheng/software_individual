    ...
    <br />
         ...
         <?php
          if ($num_row > 0) {
            ...
            $membersql = mysqli_query($dbcon,"SELECT * FROM members WHERE grpNo = $groupNo") or die(mysqli_error($dbcon));
      ...
      $memberNo = $member['regNo'];
          ...
          {
            $studentsql = mysqli_query($dbcon, "SELECT * FROM student WHERE regNo = '$memberNo'") or die(mysqli_error($dbcon));
