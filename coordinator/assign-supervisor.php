               ...
               <table class="w3-table w3">
                ...
                <tr>
                  ...
                  <?php 
                    ...
                    $result2 = mysqli_query($dbcon, "SELECT * FROM student WHERE regNo = '$member2'") or die(mysqli_error($dbcon));
                    ...
                    $result3 = mysqli_query($dbcon, "SELECT * FROM student WHERE regNo = '$member3'") or die(mysqli_error($dbcon));
                ...
                <?php 
                    if (isset($_POST['assign'])) {
                      ...
                      $gresult = mysqli_query($dbcon, "SELECT * FROM grp WHERE grpId = '$randId'") or die(mysqli_error($dbcon));
