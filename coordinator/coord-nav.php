        ...
        <div class="w3-white">
          ...
          <div id="Demo3" class="w3-hide w3-container">
            <div class="w3-padding">
              <a href="manage-student.php"><button class="w3-padding w3-btn-block bg-info w3-left-align"><i class="fa fa-users fa-fw w3-margin-right"></i>Students </button></a>
            </div>
            <div class="w3-padding">
              <a href="manage-supervisor.php"><button class="w3-margin-center w3-btn-block bg-info w3-left-align" ><i class="fa fa-users fa-fw w3-margin-right"></i>Supervisors </button></a>
            </div>
          </div>
        </div>      
      </div>
